...
@tbl-summary-1 shows the summary statistics of memory game scores before and after the treatment. The mean is similar across all groups, indicating no extreme changes in cognitive performance. However, the standard deviation (SD) is relatively high, suggesting some variation among participants.

- The median game scores remain close to the mean, showing a nearly symmetric distribution.
- The IQR (Interquartile Range) is smaller than the SD, meaning there may be outliers.
