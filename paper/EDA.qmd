...
# Boxplot to visualize the distribution of time taken to solve Memory game after taking pain killers
ggplot(clean_data, aes(x = drug, y = game_after, fill = dosage_level)) +
  geom_boxplot() +
  ggtitle("Time Taken for Memory Game after taking Drugs")
