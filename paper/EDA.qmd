...
@tbl-summary-1 shows the summary statistics of game scores before and after treatment. The mean is similar across all groups, indicating no extreme changes in cognitive performance. However, the standard deviation (SD) is relatively high, suggesting some variation among participants.
